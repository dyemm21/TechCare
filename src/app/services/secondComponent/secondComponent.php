    ...
    <div class="page-services-second-container">
        <div class="page-services-second-grid">
            ...
            <div class="page-services-second-card">
                ...
                <h3 class="page-services-second-title">Desktop Repair</h3>
            ...
            <div class="page-services-second-card">
                ...
                <h3 class="page-services-second-title">Camera Repair</h3>
        ...
        <div class="page-services-second-grid">
            ...
            <div class="page-services-second-card">
                ...
                <h3 class="page-services-second-title">MackBook Repair</h3>
                <p class="page-services-second-description">Set power royal this boss it and of take all that, space hands and of the found in week</p>
                <a href="#" class="page-services-second-read-more">Read More</a>
            </div>
